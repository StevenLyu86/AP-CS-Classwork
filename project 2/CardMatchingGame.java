/*
 * This program is to accomplish a two-dimension graphic card matching game by using Jframe. 
 * (Version 3)
 * Editor: Lillian Luo and Steven Lyu from S3C7.
...
public class CardMatchingGame implements ActionListener{ 
	...
	JButton exitButton,resetButton,retryButton; 
	JLabel fractionLable=new JLabel("0");
	JButton firstButton,secondButton;
	int grid[][] = new int[8][7];
	static boolean pressInformation=false; 
	int x0=0,y0=0,x=0,y=0,fristMsg=0,secondMsg=0,time=0; 
	int i,j,k,n;

public void init(){ 
	mainFrame=new JFrame("Link Game"); 
...
public static void main(String[] args) { 
	CardMatchingGame game = new CardMatchingGame();
	game.randomBuild(); 
	game.init(); 
	} 
}